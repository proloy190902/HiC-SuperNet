"""
HiC-SuperNet Training Script
==============================
Trains the HiC-SuperNet model on Hi-C contact map data.

Usage
-----
    python train.py \\
        --train  hicarn_10kb40kb_c40_s40_b201_nonpool_train.npz \\
        --valid  hicarn_10kb40kb_c40_s40_b201_nonpool_valid.npz \\
...
All arguments have sensible defaults – running without arguments will use
the filenames above with 100 epochs.
"""
...
def train(model,
    ...
    Args:
        model           : HiCSuperNetGenerator instance.
        train_dataset   : tf.data.Dataset for training.
        valid_dataset   : tf.data.Dataset for validation.
        test_dataset    : tf.data.Dataset for testing.
        epochs          : Maximum number of epochs.
        learning_rate   : Initial Adam learning rate.
        checkpoint_dir  : Directory for weights and history.
        patience        : Early-stopping patience (epochs without improvement).

    Returns:
        history    (dict): Training history arrays.
        test_metrics(dict): Final test set metrics.
    """
